...
export class Product {
	...
	static Clone(curr: Product): Product {
		let cln: Product = Product.CreateProduct(curr.sku, curr.name, curr.imageUrl, curr.categoryChain, curr.price);
